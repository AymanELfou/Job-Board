<x-app-layout>
    ...
    <div class="container mx-auto p-6">
        <form action="{{ route('jobs.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="company" class="block text-sm font-medium text-gray-700">Entreprise</label><!-- Label for company name -->
            ...
            <div>
                <label for="location" class="block text-sm font-medium text-gray-700">Localisation</label><!-- Label for Localisation -->
            ...
            <div>
                <label for="type" class="block text-sm font-medium text-gray-700">Type</label> <!-- Label for job type -->
            ...
            <div>
                <label for="category" class="block text-sm font-medium text-gray-700">Catégorie</label> <!-- Label for job category -->
            ...
            <div>
                <label for="salaire" class="block text-sm font-medium text-gray-700">Salaire</label> <!-- Label for salary -->
            ...
            <div>
                <label for="type_contrat" class="block text-sm font-medium text-gray-700">Type Contrat</label> <!-- Label for contract type -->
            ...
            <div>
                <label for="date_publication" class="block text-sm font-medium text-gray-700">Date publication</label> <!-- Label for publication date -->
            ...
            <div>
                <label for="description" class="block text-sm font-medium text-gray-700">Description</label> <!-- Label for job description -->
            ...
            <button type="submit" class="btn btn-primary mt-4 text-3xl bg-blue-500 leading-tight text-white font-semibold py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Créer le Job</button> <!-- Submit button for the form -->
